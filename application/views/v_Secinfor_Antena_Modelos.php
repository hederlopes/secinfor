    ...
    <div class="col-sm-12 col-sm-12">     
        <div class="panel panel-default" style="margin-top: 10px; min-height: 700px;">
            ...
            <div class="container-fluid">
                <form class="form-horizontal" role="form" action="<?= base_url('Antena-Cadastrar-Marcas') ?>" method="POST" enctype="multipart/form-data">                  
                                    ...
                                    <?php else : ?>                                     
                                        <?php foreach ($modelo->result() as $linha): ?>
                                            <tr>
                                                ...
                                                <td style='text-align:center;'><a class='btn btn-link' href='<?= base_url("Antena-Editar-Marcas") . "/" . $linha->equipamento_id ?>' role='button'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </tbody>
