...
<div class="row">
    <div class="col-xs-12 col-sm-12">     
        <div class="panel panel-default" style="margin-top: 10px; min-height: 700px;">
            ...
            <h3 class="panel-body">Editar de Equipamentos de Monitoramento</h3>
            <div class="container-fluid" style="margin-top: 30px;">
                <form class="form-horizontal" role="form" method="post" action="<?= base_url('Monitoramento-Alterar') ?>" enctype="multipart/form-data">
                    <?php if ($monitoramento != FALSE): ?>

                        <?php foreach ($monitoramento->result() as $linha): ?>
                            <input type="hidden" class="form-control" id="monitoramento_id" name="monitoramento_id" value="<?= $linha->monitoramento_id; ?>" >                     
                                ...
                                <div class="col-xs-8 col-sm-5">
                                    <select class="form-control" id="pavilhao" name="pavilhao" >
                                        ...
                                        <?php foreach ($pavilhao->result() as $row) : ?>
                                            <option value="<?= $row->pavilhao_id ?>" <?= ($row->pavilhao_id == $linha->monitoramento_pavilhao_id) ? 'selected' : '' ?>><?= $row->pavilhao_nome ?> </option>
                                        <?php endforeach; ?>
                                    </select> 
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-5">
                                    <input type="text" class="form-control" id="local" name="local" value="<?= $linha->monitoramento_local; ?>"   placeholder="Local">                     
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class=" col-xs-8 col-sm-5">
                                    <label class="radio-inline">
                                        <input type="radio" name="tipo" id="tipo_NVR" value="NVR" <?= ("NVR" == $linha->monitoramento_tipo) ? 'checked' : '' ?>> NVR
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="tipo" id="tipo_Camera" value="Camera" <?= ("Camera" == $linha->monitoramento_tipo) ? 'checked' : '' ?>> Câmera
                                    </label>
                                ...
                                <div class="col-xs-8 col-sm-5">
                                    <select class="form-control" id="equipamento" name="equipamento">
                                        ...
                                        <?php foreach ($modelo->result() as $row_modelo): ?>
                                            <option value='<?= $row_modelo->equipamento_id ?>' <?= ($row_modelo->equipamento_id == $linha->monitoramento_equipamento_id) ? 'selected' : '' ?> ><?= $row_modelo->equipamento_marca . "/" . $row_modelo->equipamento_modelo ?></option>
                                        <?php endforeach; ?>
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-5">
                                    <input type="text" class="form-control" id="hostname" name="hostname" value="<?= $linha->monitoramento_hostname; ?>"   placeholder="HOSTNAME">                     
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-5">
                                    <input type="text" class="form-control" id="mac" name="mac" value="<?= $linha->monitoramento_mac; ?>" onkeyup="valida_mac(this.value);" maxlength="17" placeholder="MAC ">                     
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-5">
                                    <input type="text" class="form-control" id="ip" name="ip" value="<?= $linha->monitoramento_ip; ?>" onblur="valida_ip(this.value);" onkeyup="MascaraCampoGeral(this, 'number');" maxlength="13" placeholder="IP">                     
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-5">
                                    <textarea class="form-control" id="obs" name="obs" placeholder="Informações Adicionais"><?= $linha->monitoramento_obs; ?></textarea>
