...
<div class="row">
    <div class="col-xs-12 col-sm-12">     
       ...
       <h3 class="panel-body">Base de Conhecimento</h3>
                ...
                <form class="form-horizontal" role="form" method="post" action="#" enctype="multipart/form-data">
                        ...
                        <?php foreach ($base_conhecimento->result() as $linha): ?>
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-7">                           
                                    <select class="form-control" id="falha" name="falha" disabled>
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-7">
                                    <textarea class="form-control" id="causa" name="causa" placeholder="Causa do Problema" disabled><?= $linha->base_conhecimento_causa ?></textarea>
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-7">
                                    <textarea class="form-control" id="solucao" name="solucao" rows="8" placeholder="Solução Aplicada" disabled><?= $linha->base_conhecimento_solucao ?></textarea>
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-7">
                                    <textarea class="form-control" id="observacoes" name="observacoes" placeholder="Informações Adicionais" disabled><?= $linha->base_conhecimento_observacoes ?></textarea>
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-8 col-sm-7">
                                    <input type="text" class="form-control" id="palavras_chave" name="palavras_chave" value="<?= $linha->base_conhecimento_palavras_chave ?>"   placeholder="Palavras-Chave" disabled>                     
                    ...
                    <div class="form-group" >
                        <div class="col-xs-12 col-sm-2 col-sm-offset-8" align="right">
                            <a class="btn btn-primary" href="<?= base_url('Secinfor-Base-Conhecimento-Consultas') ?>">
                                Fechar
                            </a>
                        </div>
                    </div>   
