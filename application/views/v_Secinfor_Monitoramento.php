...
<div class="row">
    <div class="col-xs-12 col-sm-12">     
        <div class="panel panel-default" style="margin-top: 10px; min-height: 700px;">
            ...
            <h3 class="panel-body">Cadastro de Equipamentos de Monitoramento</h3>
            <div class="container-fluid" style="margin-top: 30px;">
                <form class="form-horizontal" role="form" method="post" action="<?= base_url('Monitoramento-Cadastrar') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="margin-top: 10px;">
                        ...
                        <div class=" col-xs-8 col-sm-5">
                            <label class="radio-inline">
                                <input type="radio" name="tipo" id="tipo_NVR" value="NVR" <?= ("NVR" == $this->session->flashdata('tipo')) ? 'checked' : '' ?>> NVR
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="tipo" id="tipo_Camera" value="Camera" <?= ("Camera" == $this->session->flashdata('tipo')) ? 'checked' : '' ?>> Câmera
                            </label>
